CM.calculatedStatsUI = function(aUI, aManager, div) {
	...
	CM.calculatedStatsUI.prototype.updateDisplay = function() {
	...
	CM.calculatedStatsUI.prototype.updateDisplayGroup = function(group, tier1, tier2) {
		var data = undefined;
		if (!tier2) {
	...
	CM.calculatedStatsUI.prototype.updateDisplayHealing = function(type, abbrev) {
	...
	CM.calculatedStatsUI.prototype.drawZones = function() {
		var ul = document.createElement("ul");
		ul.setAttribute("id", CM.CSSname + "_ULcalculatedStats");
		ul.setAttribute("class", CM.CSSname + "calculatedStats");
		this.statsList = ul;
	...
	CM.calculatedStatsUI.prototype.drawChartHeader = function() {
		var li = document.createElement("li");
		li.setAttribute("id", CM.CSSname + "_LIcalculatedStatsHeader");
		li.setAttribute("class", CM.CSSname + "header " + CM.CSSname + "calculatedStatsRow");
				
		var div = document.createElement("div");
		div.setAttribute("class", CM.CSSname + "COLstatName");
		div.innerHTML = "Stat";
	...
	CM.calculatedStatsUI.prototype.defineChartRows = function() {
	...
	CM.calculatedStatsUI.prototype.defineChartRow = function(group, name, label) {
		if (CM.debug) CM.log("CM.calculatedStatsUI.prototype.defineChartRow = function(group, " + name + ", " + label + ")");
		var li = document.createElement("li");
		li.setAttribute("class", CM.CSSname + "calculatedStatsRow");
	...
	CM.calculatedStatsUI.prototype.defineHealingRatesList = function(group, name, label) {
		if (CM.debug) CM.log("CM.calculatedStatsUI.prototype.defineHealingRatesRow = function(group, " + name + ", " + label + ")");	
		var ul = document.createElement("ul");
		ul.setAttribute("id", CM.CSSname + "_ULcalculatedStatsHealing");
		ul.setAttribute("class", CM.CSSname + "calculatedStats");
		this.healingRates = ul;
		
		var head = document.createElement("li");
		head.setAttribute("class", CM.CSSname + "header " + CM.CSSname + "calculatedStatsRow");
	...
	CM.calculatedStatsUI.prototype.defineHealingRateRow = function(group, type, abbrev, label) {
		var li = document.createElement("li");
		li.setAttribute("class", CM.CSSname + "calculatedStatsRow");
